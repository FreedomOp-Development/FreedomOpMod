...
public class Command_tban extends TFM_Command
{
    ...
    public boolean run(CommandSender sender, Player sender_p, Command cmd, String commandLabel, String[] args, boolean senderIsConsole)
    {
        ...
        TFM_BanManager
                .addUuidBan(new TFM_Ban(player.getUniqueId(), player.getName(), sender.getName(), TFM_Util.parseDateOffset("5m"), ChatColor.RED + "You have been temporarily banned for 5 minutes."));
        player.kickPlayer(ChatColor.RED + "You have been temporarily banned for five minutes. Please read freedomop.boards.net for more info.");
